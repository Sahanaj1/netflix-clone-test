  ...
  return (
    ...
    >
      <div className="relative cardWrapper h-28 min-w-[180px] cursor-pointer md:h-36 md:min-w-[260px] transform transition duration-500 hover:scale-110 hover:z-[999]">
        ...
        />
        <div className="absolute inset-0 rounded sm object-cover md:rounded hover:rounded-sm overlay transition duration-500 opacity-0 hover:opacity-75">
        </div>

        <div className="space-x-3 hidden  items-center absolute p-2 bottom-0 buttonWrapper">
          <div>
            {media.type === "movie" ?
          ...
          <button
            ...
            className={`${media?.addedToFavorites && !listView && "cursor-not-allowed"
              } cursor-pointer border h-8 w-8 lg:h-12 lg:w-12 flex p-2 items-center gap-x-2 rounded-full  text-sm font-semibold transition hover:opacity-90 border-white   bg-black opacity-75 text-black`}
          >
            {media?.addedToFavorites ? (
          ...
          <button
            ...
            className="cursor-pointer p-2 border h-8 w-8 lg:h-12 lg:w-12 flex items-center gap-x-2 rounded-full  text-sm font-semibold transition hover:opacity-90  border-white  bg-black opacity-75 "
          >
